...
public class ExpiryDatesUtils {
	...
	private static List<String> expiries = Arrays.asList("30May2019", "6JUN2019", "13JUN2019", "20JUN2019", "27JUN2019",
			"4JUL2019");
...
/*		System.out.println(isTodayExpiry(expiries));
		OptionModles optionModles = OptionUtils.getOptionChain(AppConstant.NIFTY_URL_URL_BY_Expiry + "27JUN2019",
				"27JUN2019", InstrumentType.NIFTY);
		OptionChainOIData optionChainOIData = convert(optionModles);

		if (isTodayMonthlyExpiry(expiries)) {
			monthlyDirCreate();
		}

		if (isTodayExpiry(expiries)) {
			// weekly Expire
			weeklyDirCreate();
...
*/
	...
	private static String getNextMonthlyExpiry(List<String> expires) {
