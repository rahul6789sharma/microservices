...
public class ParticipantOIModle
{
  ...
  {
    return "ParticipantOIModle [date=" + this.date + ", participantType=" + this.participantType + ", futureIndexLong=" + this.futureIndexLong + ", futureIndexShort=" + this.futureIndexShort + ", futureStockLong=" + this.futureStockLong + ", futureStockShort=" + this.futureStockShort + ", optionIndexCallLong=" + this.optionIndexCallLong + ", optionIndexPutLong=" + this.optionIndexPutLong + ", optionIndexCallShort=" + this.optionIndexCallShort + ", optionIndexPutShort=" + this.optionIndexPutShort + ", optionStockCallLong=" + this.optionStockCallLong + ", optionStockPutLong=" + this.optionStockPutLong + ", optionStockCallShort=" + this.optionStockCallShort + ", optionStockPutShort=" + this.optionStockPutShort + ", totalLongContracts=" + this.totalLongContracts + ", totalShortContracts=" + this.totalShortContracts + "]";
  }
}
