...
public class StrategyModel
{
  ...
  public String toCSV()
  {
    return this.strategySerial + "," + this.expiry + "," + this.type + "," + this.strike + "," + this.avgPrice + "," + this.quantity + "," + this.target + "," + this.stopLoss + "," + this.spot_close + "," + this.des + "," + this.status + "," + this.traded_IV + "," + this.tradeDate;
  }
  ...
  {
    return "StrategyModel [strategySerial=" + this.strategySerial + ", expiry=" + this.expiry + ", type=" + this.type + ", strike=" + this.strike + ", avgPrice=" + this.avgPrice + ", quantity=" + this.quantity + ", target=" + this.target + ", stopLoss=" + this.stopLoss + ", spot_close=" + this.spot_close + ", des=" + this.des + ", status=" + this.status + ", traded_IV=" + this.traded_IV + ", tradeDate=" + this.tradeDate + ", underlying=" + this.underlying + ", underlying_ltp=" + this.underlying_ltp + ", ltp=" + this.ltp + "]";
  }
}
