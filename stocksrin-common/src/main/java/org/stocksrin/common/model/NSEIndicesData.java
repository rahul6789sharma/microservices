...
public class NSEIndicesData
{
  ...
  {
    return "ClassPojo [preOpen = " + this.preOpen + " time = " + this.time + " corrOpen = " + this.corrOpen + " status = " + this.status + " haltedStatus = " + this.haltedStatus + " mktOpen = " + this.mktOpen + " data = " + this.data + " code = " + this.code + " preClose = " + this.preClose + " corrClose = " + this.corrClose + " mktClose = " + this.mktClose + "]";
  }
}
